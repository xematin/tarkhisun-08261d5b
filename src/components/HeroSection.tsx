...
const HeroSection = () => {
  ...
  return <section id="home" className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <picture>
          <source type="image/avif" srcSet={`${hero480Avif} 480w, ${hero768Avif} 768w, ${hero1024Avif} 1024w, ${hero1440Avif} 1440w, ${hero1920Avif} 1920w`} sizes="(max-width: 480px) 480px, (max-width: 768px) 768px, (max-width: 1024px) 1024px, (max-width: 1440px) 1440px, 100vw" />
          <source type="image/webp" srcSet={`${hero480Webp} 480w, ${hero768Webp} 768w, ${hero1024Webp} 1024w, ${hero1440Webp} 1440w, ${hero1920Webp} 1920w`} sizes="(max-width: 480px) 480px, (max-width: 768px) 768px, (max-width: 1024px) 1024px, (max-width: 1440px) 1440px, 100vw" />
          <img 
            src={hero1024Webp} 
