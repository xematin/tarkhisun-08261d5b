...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    slug: "zero-to-hundred-bandar-abbas-customs-clearance",
    excerpt: "راهنمای جامع و گام‌به‌گام ترخیص کالا از بندرعباس: تمام مراحل ترخیص، مدارک لازم، هزینه‌ها، زمان ترخیص، نکات کلیدی و راهکارهای عملی برای سرعت‌بخشی به فرآیند",
    category: "راهنمای ترخیص",
    date: "۱۴۰۴/۷/۲۶",
    readTime: "۲۵ دقیقه",
    author: "تیم ترخیصان",
    keywords: ["صفر تا صد ترخیص کالا", "بندرعباس", "گمرک شهید رجایی", "مراحل ترخیص", "مدارک ترخیص", "هزینه ترخیص", "واردات بندرعباس"],
  ...
  },
  {
    ...
    excerpt: "راهنمای جامع ترخیص لوازم خانگی از گمرک بندرعباس: انواع لوازم خانگی، مدارک لازم، کد تعرفه، حقوق گمرکی، استانداردها، مجوزهای لازم و نکات کلیدی واردات",
    category: "راهنمای ترخیص",
    date: "۱۴۰۴/۸/۲۷",
    readTime: "۲۰ دقیقه",
    author: "تیم ترخیصان",
    keywords: ["ترخیص لوازم خانگی", "گمرک بندرعباس", "واردات لوازم خانگی", "یخچال", "تلویزیون", "ماشین لباسشویی", "حقوق گمرکی لوازم خانگی", "کد تعرفه لوازم خانگی", "استاندارد لوازم خانگی"],
  ...
  },
  {
    ...
    excerpt: "راهنمای جامع ترخیص موبایل و رجیستری گوشی از گمرک: مراحل رجیستری آنلاین و حضوری، مدارک لازم، حقوق گمرکی، هزینه‌ها، نکات مهم و راهکارهای عملی واردات موبایل",
    category: "راهنمای ترخیص",
    date: "۱۴۰۴/۸/۲۷",
    readTime: "۱۸ دقیقه",
    author: "تیم ترخیصان",
    keywords: ["ترخیص موبایل", "رجیستری موبایل", "رجیستری گوشی", "واردات موبایل", "گمرک بندرعباس", "ثبت سفارش موبایل", "حقوق گمرکی موبایل", "رجیستری آنلاین", "ترخیص تلفن همراه", "مدارک رجیستری"],
