    ...
    "@graph": [
      {
        ...
        "description": "راهنمای کامل مانیفست گمرکی: تعریف، انواع مانیفست (دریایی، هوایی، زمینی)، اطلاعات ضروری، نقش در ترخیص کالا، تفاوت با بارنامه و نکات مهم ثبت مانیفست",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="راهنمای کامل مانیفست گمرکی: تعریف، انواع مانیفست (دریایی، هوایی، زمینی)، اطلاعات ضروری، نقش در ترخیص کالا، تفاوت با بارنامه و نکات مهم ثبت مانیفست" />
        <meta name="keywords" content="مانیفست گمرک, مانیفست چیست, مانیفست بارنامه, مانیفست دریایی, مانیفست هوایی, مانیفست زمینی, ترخیص کالا, اسناد گمرکی, بارنامه, واردات کالا, صادرات کالا, گمرک ایران" />
        <link rel="canonical" href="https://tarkhisun.ir/blog/manifest-guide" />
        ...
        <meta property="og:url" content="https://tarkhisun.ir/blog/manifest-guide" />
            ...
            <div className="container mx-auto px-4" dir="rtl">
              <article className="max-w-4xl mx-auto prose prose-lg">
                  ...
                  <div className="space-y-6">
                    ...
                    <Card className="card-service">
                      <CardContent className="pt-6">
                        ...
                        <div className="bg-secondary/30 p-4 rounded-lg">
                          <p className="text-sm text-persian">
                            <strong>ویژگی‌های مهم:</strong> شماره پلاک وسیله نقلیه، شماره کارنه TIR (در صورت حمل بین‌المللی)، مرز ورودی و خروجی
                          </p>
                        </div>
                      </CardContent>
                    </Card>
                ...
                <div className="mb-12">
                  ...
                  <p className="text-lg leading-relaxed text-muted-foreground mb-6 text-persian">
                    مانیفست نقش کلیدی در فرآیند <Link to="/blog/bandar-abbas-comprehensive-clearance-guide" className="text-accent hover:underline">ترخیص کالا</Link> دارد:
                  </p>
                  ...
                  <div className="space-y-4">
                    <div className="bg-amber-50 border border-amber-200 p-4 rounded-lg">
                      <p className="text-persian text-amber-800">
                        <strong>⚠️ دقت در اطلاعات:</strong> هرگونه مغایرت بین مانیفست و بارنامه می‌تواند منجر به مشکلات گمرکی شود.
                      </p>
                    </div>
                    <div className="bg-amber-50 border border-amber-200 p-4 rounded-lg">
                      <p className="text-persian text-amber-800">
                    ...
                    <div className="bg-amber-50 border border-amber-200 p-4 rounded-lg">
                      <p className="text-persian text-amber-800">
                        <strong>⚠️ اصلاح مانیفست:</strong> در صورت نیاز به اصلاح، باید با هماهنگی گمرک و شرکت حمل‌ونقل اقدام شود.
                      </p>
                    </div>
                  </div>
                </div>
