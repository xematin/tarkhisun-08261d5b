...
const AIAssistant = () => {
  ...
  return (
    <section id="ai-assistant" className="py-20 bg-gradient-to-br from-accent-lighter via-white to-primary-lighter">
          ...
          <div className="card-ai-feature text-center">
            ...
            <div className="mb-8">
              ...
              <p className="text-xl text-muted-foreground leading-relaxed mb-6 text-persian">
                ...
                <br />
                <strong className="text-accent">کاملاً رایگان برای عموم</strong>
              </p>
            ...
            <Button 
              size="lg" 
              className="btn-ai text-lg px-8 py-4 text-persian"
        ...
        <div className="mt-16 max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {[
              ...
              "چه مجوزهایی برای واردات نیاز دارم؟",
              "هزینه ترخیص کالا چقدر است؟",
              "مدت زمان ترخیص چقدر طول می‌کشد؟"
            ].map((question, index) => (
              <div 
                key={index}
                className="bg-white border border-accent/20 rounded-lg p-4 text-center cursor-pointer hover:border-accent/40 transition-colors"
                onClick={handleAIClick}
              >
