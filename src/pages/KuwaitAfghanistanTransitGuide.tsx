  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="راهنمای ترانزیت کالا از کویت به افغانستان: مسیرهای حمل، مدارک، هزینه‌ها و مقررات گمرکی TIR" />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "description": "راهنمای جامع ترانزیت کالا از کویت به افغانستان: مسیرهای حمل، مدارک مورد نیاز، هزینه‌ها و مقررات گمرکی",
            "author": {
              "@type": "Organization",
              "name": "ترخیص کاران"
            },
        ...
        <main className="container mx-auto px-4 py-8 mt-20">
          ...
          <article className="max-w-4xl mx-auto">
            ...
            <section className="mb-8">
                ...
                <div className="space-y-4 mr-9">
                  <div>
                    ...
                    <ul className="list-disc mr-6 space-y-2 text-muted-foreground">
                      <li><strong className="text-foreground">بارنامه دریایی (B/L)</strong> - سند مالکیت کالا در حمل دریایی</li>
                      <li><strong className="text-foreground">بارنامه زمینی (CMR)</strong> - برای حمل جاده‌ای بین‌المللی</li>
                      <li><strong className="text-foreground">فاکتور تجاری (Commercial Invoice)</strong> - شامل مشخصات کامل کالا و ارزش</li>
                      <li><strong className="text-foreground">لیست بسته‌بندی (Packing List)</strong> - جزئیات تعداد و وزن محموله‌ها</li>
                      <li><strong className="text-foreground">گواهی مبدأ (Certificate of Origin)</strong> - صادره از اتاق بازرگانی کویت</li>
                    </ul>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="list-disc mr-6 space-y-2 text-muted-foreground">
                      <li><strong className="text-foreground">کارنه TIR</strong> - برای حمل زمینی بین‌المللی (در صورت استفاده از این روش)</li>
                      <li><strong className="text-foreground">اظهارنامه ترانزیت</strong> - از گمرک مبدأ و مقصد</li>
                      <li><strong className="text-foreground">بیمه‌نامه حمل</strong> - پوشش خسارات احتمالی در مسیر</li>
                      <li><strong className="text-foreground">مجوزهای ویژه</strong> - برای کالاهای خاص (دارویی، غذایی، الکترونیکی)</li>
                    </ul>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="list-disc mr-6 space-y-2 text-muted-foreground">
                      <li><strong className="text-foreground">پروانه واردات</strong> - از وزارت تجارت افغانستان</li>
                      <li><strong className="text-foreground">اظهارنامه گمرکی افغانستان</strong> - ثبت در سامانه ASYCUDA</li>
                      <li><strong className="text-foreground">گواهی ارزیابی قبل از بارگیری</strong> - در صورت نیاز</li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-card rounded-lg p-6 border mb-6">
                <div className="flex items-start gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground leading-relaxed mb-4">
                      هزینه‌های ترانزیت کالا از کویت به افغانستان شامل موارد مختلفی است که باید در برآورد نهایی لحاظ شوند:
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-4 mr-9">
                  <div className="bg-muted/50 rounded-lg p-4">
                    ...
                    <ul className="list-disc mr-6 space-y-2 text-muted-foreground">
                      <li><strong className="text-foreground">حمل دریایی:</strong> ۵۰۰-۱۵۰۰ دلار به ازای هر کانتینر ۲۰ فوت (به مقصد بصره)</li>
                      <li><strong className="text-foreground">حمل زمینی:</strong> ۲۰۰۰-۴۰۰۰ دلار از بصره تا افغانستان (۲۰ فوت)</li>
                      <li><strong className="text-foreground">حمل هوایی:</strong> ۳-۶ دلار به ازای هر کیلوگرم</li>
                    </ul>
                  </div>
                  ...
                  <div className="bg-muted/50 rounded-lg p-4">
                    ...
                    <ul className="list-disc mr-6 space-y-2 text-muted-foreground">
                      <li><strong className="text-foreground">حق‌الترانزیت:</strong> ۱۰۰-۳۰۰ دلار (بسته به کشورهای عبوری)</li>
                      <li><strong className="text-foreground">عوارض گمرکی افغانستان:</strong> ۵-۲۰٪ ارزش کالا (بسته به نوع کالا)</li>
                      <li><strong className="text-foreground">هزینه ترخیص:</strong> ۳۰۰-۸۰۰ دلار</li>
                    </ul>
                  </div>
                  ...
                  <div className="bg-muted/50 rounded-lg p-4">
                    ...
                    <ul className="list-disc mr-6 space-y-2 text-muted-foreground">
                      <li><strong className="text-foreground">بیمه حمل:</strong> ۰.۵-۲٪ ارزش کالا</li>
                      <li><strong className="text-foreground">انبارداری:</strong> ۱۰-۳۰ دلار در روز</li>
                      <li><strong className="text-foreground">هزینه بارگیری و تخلیه:</strong> ۱۵۰-۴۰۰ دلار</li>
                      <li><strong className="text-foreground">اسناد و مدارک:</strong> ۱۰۰-۲۰۰ دلار</li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-card rounded-lg p-6 border mb-6">
                ...
                <div className="space-y-4 mr-9">
                  <div className="flex gap-4">
                    <div className="flex-shrink-0 w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center font-bold text-primary">۱</div>
                    <div>
                      <h3 className="font-bold mb-2 text-foreground">آماده‌سازی و بارگیری در کویت (۲-۳ روز)</h3>
                      <p className="text-muted-foreground">تهیه اسناد، بسته‌بندی کالا و بارگیری در بندر یا ترمینال زمینی</p>
                    </div>
                  </div>

                  <div className="flex gap-4">
                    <div className="flex-shrink-0 w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center font-bold text-primary">۲</div>
                    <div>
                  ...
                  <div className="flex gap-4">
                    <div className="flex-shrink-0 w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center font-bold text-primary">۳</div>
                    <div>
                  ...
                  <div className="flex gap-4">
                    <div className="flex-shrink-0 w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center font-bold text-primary">۴</div>
                    <div>
                      <h3 className="font-bold mb-2 text-foreground">عبور از ایران (۳-۵ روز)</h3>
                      <p className="text-muted-foreground">ورود از خسروی، عبور از خاک ایران و خروج از مرز دوغارون یا میلک</p>
                    </div>
                  </div>

                  <div className="flex gap-4">
                    <div className="flex-shrink-0 w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center font-bold text-primary">۵</div>
                    <div>
                      <h3 className="font-bold mb-2 text-foreground">ورود و ترخیص از گمرک افغانستان (۲-۴ روز)</h3>
                      <p className="text-muted-foreground">ترخیص نهایی از گمرک‌های اسلام قلعه یا تورخم و تحویل به مقصد</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-6 p-4 bg-primary/10 rounded-lg border-r-4 border-primary">
                  <p className="text-sm text-foreground">
                    <strong>نکته مهم:</strong> زمان کل ترانزیت بسته به مسیر انتخابی، شرایط جوی، وضعیت مرزها و تعطیلات رسمی می‌تواند بین ۷ تا ۱۴ روز متغیر باشد.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-card rounded-lg p-6 border mb-6">
                ...
                <div className="space-y-4 mr-9">
                  <div className="bg-destructive/10 border-r-4 border-destructive rounded p-4">
                    ...
                    <p className="text-muted-foreground mb-2">برخی مسیرهای عبوری عراق ممکن است از نظر امنیتی چالش‌برانگیز باشند</p>
                    <p className="text-foreground"><strong>راهکار:</strong> استفاده از شرکت‌های حمل معتبر با بیمه جامع و مسیرهای امن</p>
                  </div>
                  ...
                  <div className="bg-destructive/10 border-r-4 border-destructive rounded p-4">
                    ...
                    <p className="text-foreground"><strong>راهکار:</strong> آماده‌سازی کامل اسناد پیش از رسیدن به مرز و استفاده از کارگزار گمرکی مجرب</p>
                  </div>

                  <div className="bg-destructive/10 border-r-4 border-destructive rounded p-4">
                    <h3 className="font-bold mb-2 text-foreground">⚠️ چالش: نوسانات نرخ ارز</h3>
                    <p className="text-muted-foreground mb-2">تغییرات نرخ ارز در طول مسیر ممکن است هزینه‌ها را تحت تأثیر قرار دهد</p>
                    <p className="text-foreground"><strong>راهکار:</strong> استفاده از قراردادهای ثابت قیمت و پوشش ریسک ارزی</p>
                  </div>
                  ...
                  <div className="bg-destructive/10 border-r-4 border-destructive rounded p-4">
                    ...
                    <p className="text-foreground"><strong>راهکار:</strong> همکاری با شرکت‌های حمل بین‌المللی با تجربه در این مسیر</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-card rounded-lg p-6 border mb-6">
                ...
                <div className="space-y-3 mr-9">
                  ...
                  <div className="flex gap-3">
                    <CheckCircle className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
                    <p className="text-muted-foreground">همکاری با کارگزار گمرکی در افغانستان برای تسریع فرآیند ترخیص</p>
                  </div>
                  <div className="flex gap-3">
                    <CheckCircle className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
                  ...
                  <div className="flex gap-3">
                    <CheckCircle className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
                    <p className="text-muted-foreground">محاسبه دقیق هزینه‌ها و اضافه کردن ۱۰-۱۵٪ بافر برای هزینه‌های غیرمنتظره</p>
                  </div>
                  <div className="flex gap-3">
                    <CheckCircle className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
            ...
            <section className="bg-primary/5 rounded-lg p-6 border-r-4 border-primary">
              ...
              <p className="text-foreground leading-relaxed mb-4">
                ترانزیت کالا از کویت به افغانستان با وجود چالش‌های موجود، یکی از مسیرهای تجاری مهم و اقتصادی برای بازرگانان منطقه است. موفقیت در این مسیر نیازمند برنامه‌ریزی دقیق، آمادگی کامل اسناد، همکاری با شرکت‌های حمل معتبر و آگاهی کامل از مقررات گمرکی است.
              </p>
