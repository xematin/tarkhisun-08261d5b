  ...
  const blogPosts = [
    {
      ...
      excerpt: "راهنمای جامع ترخیص مخزن ذخیره آب: انواع تانکر، مدارک لازم، کد تعرفه HS، حقوق گمرکی، مراحل واردات، استانداردها، مجوزهای بهداشتی و نکات مهم خرید و ترخیص",
      date: "۱۴۰۴/۷/۲۲",
      readTime: "۱۷ دقیقه",
      author: "تیم ترخیصان",
    ...
    },
    {
      ...
      excerpt: "راهنمای جامع واردات کالا از دبی به بندرعباس: روش‌های حمل، مدارک لازم، هزینه‌ها، زمان ترخیص، مراحل گمرکی، مزایا و نکات کلیدی تجارت با امارات",
      date: "۱۴۰۴/۷/۲۱",
      readTime: "۲۰ دقیقه",
      author: "تیم ترخیصان",
    ...
    },
    {
      ...
      excerpt: "راهنمای جامع ترخیص ژنراتور از گمرک بندرعباس: مدارک لازم، کد تعرفه HS، حقوق گمرکی، مراحل واردات، مجوزهای لازم و نکات کلیدی ترخیص انواع ژنراتور برق",
      date: "۱۴۰۴/۷/۲۰",
      readTime: "۱۸ دقیقه",
      author: "تیم ترخیصان",
    ...
    },
    {
      ...
      excerpt: "راهنمای جامع گذرگاه مرزی اسلام قلعه: موقعیت جغرافیایی، خدمات گمرکی، مراحل ترانزیت و صادرات، مدارک لازم و نکات کلیدی تجارت با افغانستان",
      date: "۱۴۰۴/۷/۱۹",
      readTime: "۱۵ دقیقه",
      author: "تیم ترخیصان",
    ...
    },
    {
      ...
      excerpt: "راهنمای جامع ترانزیت کالا از کویت به افغانستان: مسیرها، مدارک، هزینه‌ها و نکات کلیدی حمل و نقل بین‌المللی",
      date: "۱۴۰۴/۷/۱۸",
      readTime: "۱۲ دقیقه",
      author: "تیم ترخیصان",
    ...
    },
    {
      ...
      excerpt: "راهنمای جامع کمیسیون ماده 1 گمرک: تعریف، ترکیب اعضا، وظایف، نحوه رسیدگی به اختلافات ارزش گمرکی، مراحل اعتراض، مدارک لازم، آرای کمیسیون و نکات کلیدی",
      date: "۱۴۰۴/۷/۱۷",
      readTime: "۱۸ دقیقه",
      author: "تیم ترخیصان",
      slug: "article-1-commission-customs-guide",
      category: "قوانین گمرکی"
    },
    {
      id: 12,
      title: "ترخیص ماشین آلات حفاری از گمرک | راهنمای کامل واردات ماشین آلات سنگین",
      excerpt: "راهنمای جامع ترخیص ماشین آلات حفاری از گمرک: مدارک لازم، تعرفه و حقوق گمرکی، کد HS، مراحل واردات، مجوزها و نکات مهم ترخیص انواع ماشین آلات سنگین",
      date: "۱۴۰۴/۷/۱۶",
      readTime: "۲۰ دقیقه",
      author: "تیم ترخیصان",
      slug: "excavation-machinery-customs-clearance-guide",
      category: "راهنمای ترخیص"
    },
    {
      id: 11,
