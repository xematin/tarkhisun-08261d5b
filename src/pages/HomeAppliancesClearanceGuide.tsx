...
const HomeAppliancesClearanceGuide = () => {
  const description = "راهنمای ترخیص لوازم خانگی از گمرک بندرعباس: مدارک، تعرفه، حقوق گمرکی و مجوزهای واردات یخچال، تلویزیون و ماشین لباسشویی";
              ...
              <div className="prose prose-lg max-w-none text-foreground">
                ...
                <section className="mb-12">
                  ...
                  <p className="text-lg leading-relaxed mb-4 text-muted-foreground text-persian">
                    <strong>واردات و ترخیص لوازم خانگی از گمرک بندرعباس</strong> یکی از پرتقاضاترین خدمات ترخیص کالا در این بندر است. با توجه به تنوع بالای لوازم خانگی (یخچال، تلویزیون، ماشین لباسشویی، ظرفشویی، اجاق گاز، کولر، جاروبرقی و...) و پیچیدگی‌های مربوط به استانداردها، مجوزها و <Link to="/blog/customs-tariff-guide" className="text-accent hover:underline">تعرفه‌های گمرکی</Link>، آگاهی از فرآیند ترخیص اصولی این کالاها بسیار ضروری است.
                  </p>
                  <p className="text-lg leading-relaxed mb-4 text-muted-foreground text-persian">
                    در این راهنمای جامع، تمامی جوانب ترخیص لوازم خانگی از <strong>گمرک بندرعباس شهید رجایی</strong> را بررسی می‌کنیم. برای درک بهتر فرآیند، آشنایی با <Link to="/blog/hs-code-guide" className="text-accent hover:underline">کد HS کالا</Link> و نحوه <Link to="/blog/ntsw-complete-guide" className="text-accent hover:underline">ثبت سفارش در سامانه جامع تجارت</Link> ضروری است تا واردکنندگان بتوانند با اطمینان بیشتری نسبت به واردات و ترخیص کالاهای خود اقدام کنند.
                  </p>
                </section>
