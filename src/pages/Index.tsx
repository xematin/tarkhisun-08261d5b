...
const Index = () => {
  useEffect(() => {
    ...
    // SEO Meta Tags
    document.title = "مشاوره امور گمرکی بندرعباس شهید رجایی | ترخیصان";

    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute(
        "content",
        "مشاوره تخصصی امور گمرکی و ترخیص کالا در بندرعباس بندر شهید رجایی با 20+ سال تجربه. خدمات ترخیص سریع، صدور کمیسیون ماده یک، مشاوره گمرکی. تماس : 09177380080",
      );
    } else {
