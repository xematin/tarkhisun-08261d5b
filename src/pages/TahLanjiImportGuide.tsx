  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="راهنمای واردات ته لنجی (ملوانی): تعریف، تفاوت با واردات رسمی، ریسک‌های قانونی و جریمه‌ها" />
              ...
              <div className="max-w-4xl mx-auto space-y-12">
                ...
                <div>
                  ...
                  <div className="space-y-4 text-lg leading-relaxed text-persian">
                    <p>
                      <strong>واردات ته لنجی</strong> یا <strong>ملوانی</strong> به روشی از ورود کالا به کشور گفته می‌شود که از طریق لنج‌های سنتی و بدون طی مراحل رسمی گمرکی انجام می‌شود. این نوع واردات عمدتاً در بنادر جنوبی ایران مانند بندرعباس، بندر لنگه و جزایر خلیج فارس رایج بوده است. برای آشنایی با <Link to="/blog/import-export-guide-iran" className="text-accent hover:underline">روش‌های قانونی واردات</Link>، مقاله مربوطه را مطالعه کنید.
                    </p>
                    <p>
                      در این روش، کالاها بدون ارائه مدارک رسمی، <Link to="/blog/ntsw-complete-guide" className="text-accent hover:underline">ثبت سفارش</Link>، پرداخت <Link to="/blog/customs-tariff-guide" className="text-accent hover:underline">حقوق گمرکی</Link> و عوارض قانونی وارد کشور می‌شوند و معمولاً از مسیرهای غیررسمی و دور از نظارت مقامات گمرکی حمل می‌شوند.
                    </p>
                  </div>
                </div>
