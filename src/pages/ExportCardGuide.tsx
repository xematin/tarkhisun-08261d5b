...
import { ArrowRight, CheckCircle2, FileText, Calendar, Clock, User, AlertCircle, TrendingUp, AlertTriangle } from "lucide-react";
...
const ExportCardGuide = () => {
  ...
  const structuredData = {
    ...
    "description": "راهنمای کامل کارت صادراتی: تعریف، تفاوت با کارت بازرگانی، مدارک لازم، شرایط دریافت و مراحل صدور فوری در سال ۱۴۰۴",
    "image": "https://tarkhisun.ir/images/blog/export-card-documents.webp",
    "author": {
      "@type": "Organization",
      "name": "ترخیصان",
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://tarkhisun.ir/blog/export-card-complete-guide"
    },
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="راهنمای کارت صادراتی: تعریف، تفاوت با کارت بازرگانی، مدارک، شرایط و مراحل دریافت فوری در ۱۴۰۴" />
        <meta name="keywords" content="کارت صادراتی, تفاوت کارت صادراتی و بازرگانی, دریافت کارت صادراتی, صادرات ایران, مجوز صادرات, کارت صادرات, شرایط کارت صادراتی, مدارک کارت صادراتی, هزینه کارت صادراتی" />
        <link rel="canonical" href="https://tarkhisun.ir/blog/export-card-complete-guide" />
        <meta property="og:title" content="کارت صادراتی چیست؟ تفاوت با کارت بازرگانی + دریافت فوری ۱۴۰۴" />
        <meta property="og:description" content="راهنمای جامع کارت صادراتی: تعریف، مقایسه با کارت بازرگانی، مدارک و مراحل صدور" />
        <meta property="og:type" content="article" />
        <meta property="og:url" content="https://tarkhisun.ir/blog/export-card-complete-guide" />
        <meta property="og:locale" content="fa_IR" />
        <meta property="og:site_name" content="ترخیصان" />
        <meta property="og:image" content="https://tarkhisun.ir/images/blog/export-card-documents.webp" />
        ...
        <meta name="twitter:image" content="https://tarkhisun.ir/images/blog/export-card-documents.webp" />
      ...
      <main>
        <ArticleBreadcrumb category="تجارت بین‌الملل" articleTitle="کارت صادراتی چیست؟ تفاوت با کارت بازرگانی + نحوه دریافت فوری ۱۴۰۴" />
          ...
          <div className="container mx-auto px-4" dir="rtl">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-xl text-muted-foreground text-persian leading-relaxed">
                <strong>کارت صادراتی</strong> یکی از مجوزهای کلیدی برای ورود به بازار صادرات ایران است. در این مقاله به‌طور کامل با تعریف کارت صادراتی، تفاوت آن با <Link to="/blog/business-card-complete-guide" className="text-accent hover:underline">کارت بازرگانی</Link>، شرایط دریافت و نحوه اخذ فوری آن در سال ۱۴۰۴ آشنا می‌شوید.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="max-w-4xl mx-auto prose prose-lg">
              ...
              <section className="mb-12">
                ...
                <p className="text-body mb-6 text-persian">
                  <strong>کارت صادراتی</strong> مجوزی است که توسط اتاق بازرگانی، صنایع، معادن و کشاورزی ایران صادر می‌شود و به دارنده آن امکان می‌دهد تا کالاهای تولیدی یا بازرگانی خود را به کشورهای دیگر صادر کند. این کارت به‌ویژه برای تولیدکنندگان و بازرگانانی که قصد ورود به <Link to="/blog/import-export-guide-iran" className="text-accent hover:underline">بازار صادرات</Link> را دارند، ضروری است.
                </p>
                <p className="text-body mb-6 text-persian">
                  برخلاف تصور عمومی، کارت صادراتی با کارت بازرگانی متفاوت است. کارت صادراتی به‌صورت اختصاصی برای فعالیت‌های صادراتی طراحی شده و شرایط دریافت آسان‌تری نسبت به کارت بازرگانی دارد. این ویژگی باعث شده تا صادرکنندگان کوچک و متوسط بتوانند راحت‌تر وارد بازار صادرات شوند.
                </p>
                ...
                <div className="bg-accent/10 border-r-4 border-accent rounded-lg p-6 mb-6">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="text-persian">
                      ...
                      <span>با داشتن کارت صادراتی می‌توانید از تسهیلات و مشوق‌های صادراتی دولت مانند بازگشت ارز، معافیت‌های مالیاتی و تسهیلات بانکی بهره‌مند شوید.</span>
                    </div>
                  </div>
                </div>
              </section>
              ...
              <section className="mb-12">
                ...
                <p className="text-body mb-6 text-persian">
                  یکی از سؤالات رایج در میان فعالان تجاری، تفاوت کارت صادراتی و کارت بازرگانی است. در جدول زیر این تفاوت‌ها را به‌صورت کامل بررسی می‌کنیم:
                </p>
                ...
                <div className="overflow-x-auto mb-8">
                  <table className="w-full border-collapse border border-border rounded-lg">
                    ...
                    <tbody>
                      <tr>
                        <td className="border border-border p-4 text-persian"><strong>حوزه فعالیت</strong></td>
                      ...
                      <tr className="bg-secondary/30">
                        <td className="border border-border p-4 text-persian"><strong>شرایط دریافت</strong></td>
                      ...
                      <tr>
                        <td className="border border-border p-4 text-persian"><strong>هزینه صدور</strong></td>
                        <td className="border border-border p-4 text-persian">کمتر</td>
                        <td className="border border-border p-4 text-persian">بیشتر</td>
                      </tr>
                      <tr className="bg-secondary/30">
                        <td className="border border-border p-4 text-persian"><strong>مناسب برای</strong></td>
                      ...
                      <tr>
                        <td className="border border-border p-4 text-persian"><strong>نیاز به کد اقتصادی</strong></td>
                        <td className="border border-border p-4 text-persian">بله</td>
                        <td className="border border-border p-4 text-persian">بله</td>
                      </tr>
                      <tr className="bg-secondary/30">
                        <td className="border border-border p-4 text-persian"><strong>اعتبار کارت</strong></td>
              ...
              <section className="mb-12">
                ...
                <div className="bg-secondary/30 rounded-xl p-6 mb-6">
                  ...
                  <ul className="space-y-3">
                    ...
                    <li className="flex items-start gap-3 text-persian">
                      <CheckCircle2 className="w-5 h-5 text-accent mt-1 flex-shrink-0" />
                      <span>داشتن <Link to="/blog/ntsw-complete-guide" className="text-accent hover:underline">کد اقتصادی</Link> معتبر</span>
                    </li>
                    <li className="flex items-start gap-3 text-persian">
                      <CheckCircle2 className="w-5 h-5 text-accent mt-1 flex-shrink-0" />
              ...
              <section className="mb-12">
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex gap-4 p-4 bg-secondary/30 rounded-lg">
                    <div className="flex-shrink-0 w-10 h-10 bg-accent text-white rounded-full flex items-center justify-center font-bold">۱</div>
                    <div className="text-persian">
                      <h3 className="font-bold mb-2">ثبت‌نام در سامانه جامع تجارت</h3>
                      <p className="text-muted-foreground">ابتدا در <Link to="/blog/ntsw-complete-guide" className="text-accent hover:underline">سامانه ntsw.ir</Link> ثبت‌نام کرده و احراز هویت انجام دهید.</p>
                    </div>
                  </div>
                  
                  <div className="flex gap-4 p-4 bg-secondary/30 rounded-lg">
                    <div className="flex-shrink-0 w-10 h-10 bg-accent text-white rounded-full flex items-center justify-center font-bold">۲</div>
                    <div className="text-persian">
                      <h3 className="font-bold mb-2">عضویت در اتاق بازرگانی</h3>
                      <p className="text-muted-foreground">به اتاق بازرگانی استان محل فعالیت مراجعه کرده و فرم عضویت را تکمیل کنید.</p>
                    </div>
                  </div>
                  
                  <div className="flex gap-4 p-4 bg-secondary/30 rounded-lg">
                    <div className="flex-shrink-0 w-10 h-10 bg-accent text-white rounded-full flex items-center justify-center font-bold">۳</div>
                    <div className="text-persian">
                      <h3 className="font-bold mb-2">ارائه مدارک</h3>
                      <p className="text-muted-foreground">تمامی مدارک لازم را به‌صورت فیزیکی و الکترونیکی ارائه دهید.</p>
                    </div>
                  </div>
                  
                  <div className="flex gap-4 p-4 bg-secondary/30 rounded-lg">
                    <div className="flex-shrink-0 w-10 h-10 bg-accent text-white rounded-full flex items-center justify-center font-bold">۴</div>
                    <div className="text-persian">
                      <h3 className="font-bold mb-2">پرداخت هزینه‌ها</h3>
                      <p className="text-muted-foreground">حق عضویت اتاق بازرگانی و هزینه صدور کارت را پرداخت نمایید.</p>
                    </div>
                  </div>
                  
                  <div className="flex gap-4 p-4 bg-secondary/30 rounded-lg">
                    <div className="flex-shrink-0 w-10 h-10 bg-accent text-white rounded-full flex items-center justify-center font-bold">۵</div>
                    <div className="text-persian">
                      <h3 className="font-bold mb-2">دریافت کارت</h3>
                      <p className="text-muted-foreground">پس از تأیید مدارک، کارت صادراتی ظرف ۷ تا ۱۴ روز کاری صادر می‌شود.</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-yellow-50 border-r-4 border-yellow-500 rounded-lg p-6">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="text-persian">
                      ...
                      <span>برای دریافت فوری کارت صادراتی (۳ تا ۵ روز کاری)، می‌توانید از خدمات پیگیری ویژه اتاق بازرگانی استفاده کنید. همچنین تکمیل دقیق مدارک و عدم نقص در پرونده، سرعت صدور را افزایش می‌دهد.</span>
                    </div>
                  </div>
                </div>
              </section>
              ...
              <section className="mb-12">
                ...
                <p className="text-body mb-6 text-persian">
                  هزینه‌های صدور کارت صادراتی شامل چند بخش است که بسته به نوع شخص حقیقی یا حقوقی و همچنین استان محل فعالیت متفاوت است:
                </p>
              ...
              <section className="mb-12">
                ...
                <div className="space-y-4">
                  <Card className="card-service">
                    <CardHeader>
                      <CardTitle className="text-persian text-lg">آیا بدون کارت بازرگانی می‌توان کارت صادراتی گرفت؟</CardTitle>
                    </CardHeader>
                    <CardContent>
                      <p className="text-body text-persian">
                        بله، کارت صادراتی به‌صورت مستقل قابل دریافت است و نیازی به داشتن کارت بازرگانی نیست. این یکی از مزایای اصلی کارت صادراتی برای صادرکنندگان جدید است.
                      </p>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="card-service">
                    ...
                    <CardContent>
                      <p className="text-body text-persian">
                        اعتبار کارت صادراتی یک سال است و باید قبل از انقضا تمدید شود. فرآیند تمدید ساده‌تر از صدور اولیه بوده و معمولاً ظرف ۳ تا ۵ روز انجام می‌شود.
                      </p>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="card-service">
                    <CardHeader>
                      <CardTitle className="text-persian text-lg">آیا با کارت صادراتی می‌توان واردات هم انجام داد؟</CardTitle>
                    </CardHeader>
                    <CardContent>
                      <p className="text-body text-persian">
                        خیر، کارت صادراتی فقط مجوز صادرات را می‌دهد. برای فعالیت در حوزه واردات باید <Link to="/blog/business-card-complete-guide" className="text-accent hover:underline">کارت بازرگانی</Link> دریافت کنید که شامل هر دو فعالیت واردات و صادرات می‌شود.
                      </p>
                    </CardContent>
                  </Card>
                </div>
              ...
              <section className="mb-12">
                ...
                <p className="text-body mb-6 text-persian">
                  <strong>کارت صادراتی</strong> یکی از مهم‌ترین مجوزها برای ورود به بازار صادرات ایران است. این کارت با شرایط آسان‌تر و هزینه کمتر نسبت به کارت بازرگانی، فرصت مناسبی برای تولیدکنندگان و بازرگانان کوچک و متوسط فراهم می‌کند. با رعایت مراحل و ارائه مدارک کامل، می‌توانید ظرف ۷ تا ۱۴ روز کاری کارت صادراتی خود را دریافت کنید.
                </p>
                <p className="text-body text-persian">
                  برای دریافت مشاوره تخصصی در زمینه صدور کارت صادراتی و <Link to="/blog/zero-to-hundred-bandar-abbas-customs-clearance" className="text-accent hover:underline">ترخیص کالا از گمرک</Link>، با کارشناسان ترخیصان تماس بگیرید.
                </p>
              </section>
